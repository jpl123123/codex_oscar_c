...
extern "C" void oscar_history_launch(void* stream,const void* q,const void* cache,const void* bt,const void* qsl,
  const void* hs,const void* he,const void* qpos,void* out,void* lse,void* ws,HistoryPlan plan) {
    oscar_history_cv_kernel<<<plan.cores,nullptr,stream>>>((GM_ADDR)q,(GM_ADDR)cache,(GM_ADDR)bt,(GM_ADDR)qsl,(GM_ADDR)hs,(GM_ADDR)he,(GM_ADDR)qpos,(GM_ADDR)ws,plan);
    oscar_history_reduce_kernel<<<plan.cores*2,nullptr,stream>>>((GM_ADDR)ws,(GM_ADDR)out,(GM_ADDR)lse,(GM_ADDR)qsl,plan);
}
extern "C" void oscar_window_cv_launch(void* stream,const void* q,const void* k,const void* v,const void* wk,
 const void* wv,const void* pos,const void* map,const void* qsl,const void* qp,void* out,void* lse,void* ws,HistoryPlan plan) {
    oscar_window_cv_kernel<<<plan.cores,nullptr,stream>>>((GM_ADDR)q,(GM_ADDR)k,(GM_ADDR)v,(GM_ADDR)wk,(GM_ADDR)wv,(GM_ADDR)pos,(GM_ADDR)map,(GM_ADDR)qsl,(GM_ADDR)qp,(GM_ADDR)ws,plan);
    oscar_history_reduce_kernel<<<plan.cores*2,nullptr,stream>>>((GM_ADDR)ws,(GM_ADDR)out,(GM_ADDR)lse,(GM_ADDR)qsl,plan);
}
